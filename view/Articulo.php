      ...
      <div class="col-md-12">
          <div class="panel-body">
            ...
            <ul class="nav nav-tabs pull-right">
              <li><a onclick="cerrarformulario()" href="#nuevox" data-toggle="tab">Nuevo</a></li>
       ...
       <!-- MODAL DE BARRAS -->
        <div class="modal fade" id="modalbarra" data-backdrop="static" data-keyboard="false" data-keyboard=”false” tabindex=”-1″  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" role=”dialog”>
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-body">
                  <form name="fbarra" id="fbarra" method="POST">
                    <div class="row"> 
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="form-group">
                      <label>Codigo del producto:</label>
                       <input type="text" readonly class="form-control" name="codigobarra" id="codigobarra">
                    </div>
                  </div>
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="form-group">
                      <label>Nombre del producto:</label>
                       <input type="text" readonly class="form-control" name="nombrebarra" id="nombrebarra">
                    </div>
                  </div>
                </div>
                  <div class="row">
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                     <div class="form-group">
                      <label>Cantidad de etiquetas:</label>
                       <input type="number" onkeydown="return false" class="form-control" name="num" id="num">
                    </div>
                  </div>
                </div>
               <!-- end modal body -->
             ...
             <button type="button" onclick="obtener()"  class="btn btn-primary btn-md ">
              <span class="fa fa-save"></span>
            </button>
             <button type="button" onclick="cerrar()" class="btn btn-danger btn-md" data-dismiss="modal">
