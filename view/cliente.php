          ...
          <div class="panel-body">
           ...
           <table id="listado" class="table table-bordered">
            ...
            <div class="box-header">
              ...
              <h5 class="box-title">Registrar Clientes</h5>
              <div class="box-body">
                <!-- form -->
               <form name="formulario" id="formulario" method="POST">
               <input type="hidden" id="idpersona" name="idpersona">
              <input type="hidden" value="cliente" name="tipo_persona" id="tipo_persona">
                <!-- fila1 -->
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ">
                   ...
                   <div class="form-group">
                     <label class="control-label">Apellido</label>
                      ...
                      placeholder="Apellido"  onkeyup="mayus(this);">
                     </div>
                  </div>
                </div>
                <!-- fila2 -->
                  ...
                  <div class="col-lg-3 col-md-5 col-sm-6 col-xs-12 ">
                   <div class="form-group">
                     <label class="control-label">@Gmail</label>
                      ...
                      placeholder="Correo electronico"  onkeyup="mayus(this);">
                     </div>
                  </div>
              </div>
                 <br><br>
