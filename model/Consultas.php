...
Class Consultas
{
    ...
    public function ventasfechacliente($fecha_inicio,$fecha_fin)
    {
        ...
        p.nombre as cliente,p.apellido as apellidoC,v.total_venta as total,v.estado FROM venta v 
 ...
 // total de clientes registrados
  public function total_clientes()
   ...
   //VENTAS RECHAZADAS HOY
    ...
    {
        $sql="SELECT U.nombre as vendedorN,u.apellido as vendedorA,V.idventa as idventa,V.fecha_hora,V.total_venta,P.nombre,P.apellido FROM venta V
    ...
    // consulta web productos
    
    public function Mostrario(){
    $sql="SELECT a.nombre as nombre,a.imagen as imagen
    from articulo a
    INNER JOIN detalle_ingreso d  ON d.idarticulo = a.idarticulo";
    return ejecutarConsulta($sql);
    }
}
